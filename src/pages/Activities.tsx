...
const experiences = [
  ...
  },
  {
    ...
    description:
      "I was part of the school badminton team that won the County Championship. Competing at a high level required focus, discipline, and teamwork, particularly under pressure during decisive matches. This achievement reflected sustained training and effective coordination as a team.",
    icon: Trophy,
  ...
  },
  {
    ...
    description:
      "I completed my GCSE examinations across a broad range of subjects, consolidating foundational knowledge and exam technique. The revision process improved my ability to plan long-term study, prioritise weaker areas, and perform under pressure. Key highlights being: 9s in Maths, Physics, Chemistry, Biology and an A in FSMQ (Add maths), as well as 8s in Computer Science and English Literature. This experience helped shape my academic interests and prepared me for the demands of A-level study.",
    icon: GraduationCap,
  ...
  },
  {
    ...
    description:
      "I completed the Silver Duke of Edinburgh Award, involving volunteering, physical activity, skill development, and a team expedition. This experience strengthened my teamwork, leadership, and problem-solving skills, particularly during the expedition where planning, communication, and adaptability were essential in challenging conditions.",
    icon: Mountain,
  ...
  },
  {
    ...
    sortDate: new Date(2025, 6),
    description:
      "While in India, I shadowed a doctor working with a free ambulance service providing medical assistance to local communities. I observed patient care in time-sensitive situations and gained insight into clinical decision-making, triage, and the importance of accessible healthcare. This experience deepened my interest in medicine and public health.",
    icon: Stethoscope,
  ...
  },
  {
    ...
    sortDate: new Date(2026, 0),
    description:
      "Our school badminton team finished top of the league table this season. Across multiple fixtures, I contributed consistently while adapting tactics based on opponents. The experience reinforced the importance of long-term consistency, communication, and maintaining performance across a full season.",
    icon: Trophy,
                  ...
                  <div className="flex-1 p-8">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {experience.tags.map((tag) => (
                        <span
                          key={tag}
                          className={`px-3 py-1 text-sm rounded-full font-medium ${getTagColor(
                            tag
                          )}`}
                        >
                          {tag}
